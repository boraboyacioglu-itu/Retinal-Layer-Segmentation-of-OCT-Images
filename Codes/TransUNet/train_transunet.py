...
# Additional Scripts
from utils_octa.transunet_octa import TransUNet
from utils_octa.utils_octa import dice_loss
...
class TransUNetSeg:
    ...
    def train_step(self, **params):
        ...
        loss = self.criterion(pred_mask, params['mask'], cfg.transunet.class_num)
        loss.backward()
        self.optimizer.step()
